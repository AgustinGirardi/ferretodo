  ...
  return (
    <div>
      ...
      <div className="mt-6 max-w-md rounded-xl border border-border bg-surface p-5">
        ...
        <a
          href="/admin/backup"
          className="inline-flex items-center gap-2 rounded-md border border-border px-4 py-2 text-sm font-medium text-fg transition-colors hover:border-brand-500 hover:text-brand-500"
        >
